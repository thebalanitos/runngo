			...
			<div class="col-md-8 col-lg-6">
				...
				<div class="card">
					<h3 class="card-header text-xs-center">
						<strong>Lacul Tineretului</strong>
					</h3>
					<div>
						<li class="list-group-item">
						<object data="map/track3/" width="100%" height="400"> <embed src="map/track3/" width="100%" height="400"> </object>
						</li>
						<li class="list-group-item">
							<div class="row">
								<div class="col-xs-6 text-xs-left">Location</div>
								<div class="col-xs-6 text-xs-right"><strong>Bucuresti</strong></div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row">
				...
				<div class="card">
					<h3 class="card-header">
						...
						<div class="row">
							...
							<div class="col-xs-4 text-xs-right"><strong>24:52</strong></div>
							</a>
						</div>
					</li>
					<li class="list-group-item">
						<div class="row">
							...
							<div class="col-xs-4 text-xs-right"><strong>34:09</strong></div>
							</a>
						</div>
					</li>
				</div>
