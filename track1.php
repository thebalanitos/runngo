			...
			<div class="col-md-8 col-lg-6">
				...
				<div class="card">
					<h3 class="card-header text-xs-center">
						<strong>Vaslui Tour</strong>
					</h3>
					<div>
						<li class="list-group-item">
						<object data="map/track1/" width="100%" height="400"> <embed src="map/track1/" width="100%" height="400"> </object>
						</li>
						<li class="list-group-item">
							<div class="row">
				...
				<div class="card">
					<h3 class="card-header">
						...
						<div class="row">
							<a href="user2.php">
							<div class="col-xs-8 text-xs-left"><img src="img/susu.jpg" class="avatar">Eduard Susu</div>
							<div class="col-xs-4 text-xs-right"><strong>1:20:09</strong></div>
							</a>
						</div>
					</li>
					<li class="list-group-item">
						<div class="row">
							...
							<div class="col-xs-4 text-xs-right"><strong>1:24:09</strong></div>
							</a>
						</div>
					</li>
				</div>
