				...
				<div class="card">
					<div class="input-group card-header">
						<div class="form-group  has-feedback">
							<input type="text" class="form-control" id="inputSuccess5" placeholder="Search People">
						</div>
					...
					<div class="card-block">
						<div class="media list-group-item">
							...
							<div class="media-left media-middle">
								<img class="media-object img-thumbnail" src="img/tode.jpg">
							</div>
							<div class="media-body">
								<h5 class="media-heading"><strong>Alexandru Toderica</strong></h5>
									<p>Iasi 
									<br>Total: 80km</p>
							</div>
							</a>							
						...
						<div class="media list-group-item">
							<a href="user2.php">
							<div class="media-left media-middle">
									<img class="media-object img-thumbnail" src="img/susu.jpg">	
							</div>
							<div class="media-body">
								<h5 class="media-heading"><strong>Eduard Susu</strong></h5>
									<p>Vaslui
									<br>Total: 60km</p>
							</div>	
							</a>							
