		...
		<div class="row">
			...
			<div class="col-md-8 col-lg-6">
				...
				<div class="card-header text-xs-center">
					...
					<h3><p><strong>Andone Bogdan</strong></p></h3>
				</div>
					...
					<div class="card-block">	
						...
						<li class="list-group-item">
							<div class="row">
								...
								<div class="col-xs-6 text-xs-right"><strong>100kg</strong></div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row">
								<div class="col-xs-6 text-xs-left">Height:</div>
								<div class="col-xs-6 text-xs-right"><strong>1.50m</strong></div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row">
								<div class="col-xs-6 text-xs-left">Sex:</div>
								<div class="col-xs-6 text-xs-right"><strong>None</strong></div>
							</div>
						</li>
				...
				<div class="card">
					...
					<div class="card-footer">
						<strong>There are no Activities for this Fat Ass</strong>
					</div>
