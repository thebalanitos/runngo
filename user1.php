		...
		<div class="row">
			...
			<div class="col-md-8 col-lg-6">
				...
				<div class="card-header text-xs-center">
					...
					<h3><p><strong>Alexandru Toderica</strong></p></h3>
				</div>
					...
					<div class="card-block">	
						...
						<li class="list-group-item">
							<div class="row">
								...
								<div class="col-xs-6 text-xs-right"><strong>80 kg</strong></div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row">
								<div class="col-xs-6 text-xs-left">Height:</div>
								<div class="col-xs-6 text-xs-right"><strong>1.60 m</strong></div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row">
