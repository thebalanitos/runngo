			...
			<div class="col-md-8 col-lg-6">
				...
				<div class="card">
					<h3 class="card-header text-xs-center">
						<strong>Splai Bahlui</strong>
					</h3>
					<div>
						<li class="list-group-item">
						<object data="map/track2/" width="100%" height="400"> <embed src="map/track2/" width="100%" height="400"> </object>
						</li>
						<li class="list-group-item">
							<div class="row">
								<div class="col-xs-6 text-xs-left">Location</div>
								<div class="col-xs-6 text-xs-right"><strong>Iasi</strong></div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row">
				...
				<div class="card" id="todenote">
					<h3 class="card-header">
						<strong>Notes from Users</strong>
					</h3>
					<div class="card-block">
						<a href="user1.php">
						<h6><img src="img/tode.jpg" class="avatar">
							<strong>Alexandru Toderica</strong></h6>
						</a>
					</div>
						<p><div class="text-xs-center"><font size="6rem"><strong>Parca is la formula 1 baaa</strong></font></div></p>	
					<div class="row">
						<div class="col-xs-5 text-xs-left" style="margin-top:10px">&nbsp;&nbsp;1 week ago</div>
				...
				<div class="card">
					...
					<li class="list-group-item">
						<div class="row">
							<a href="user1.php">
							<div class="col-xs-8 text-xs-left"><img src="img/tode.jpg" class="avatar">Alexandru Toderica</div>
							<div class="col-xs-4 text-xs-right"><strong>44:32</strong></div>
							</a>
						</div>
					</li>
					<li class="list-group-item">
						<div class="row">
							<a href="user3.php">
							<div class="col-xs-8 text-xs-left"><img src="img/bogdan.jpg" class="avatar">Andone Bogdan</div>
							<div class="col-xs-4 text-xs-right"><strong>1:02:10</strong></div>
							</a>
						</div>
					</li>
				</div>
